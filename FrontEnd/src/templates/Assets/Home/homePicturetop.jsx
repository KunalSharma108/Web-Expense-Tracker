    ...
    <div className="home-big-pic">
        <div className="home-big-pic-content">
            ...
            <div className="button-row ">
                {props.cookie == false ? (
                    <Link className="button text-light mx-3 titillium-web-heavy" to={'/user/SignUp'}>Sign Up</Link>
                ) : null}
                <Link className="button text-light mx-3 titillium-web-heavy " to={'/user-guide'}>How to ?</Link>
            </div>
        </div>
    </div>
  )
